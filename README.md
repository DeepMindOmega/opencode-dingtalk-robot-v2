...
| 配置项 | 说明 | 示例 |
|--------|------|------|
| CLIENT_ID | 钉钉应用的 AppKey | your_dingtalk_app_key_here |
...
### v1.1 (2026-02-16)
- ✅ 添加 Token 使用量跟踪和显示（每次回复末尾显示详细 Token 信息）
- ✅ 自动 Compact 功能（当会话 Token 超过 100,000 时自动压缩）
- ✅ 心跳监控中自动刷新 Access Token（防止 Token 过期）
- ✅ 修复私聊和群聊会话隔离问题
- ✅ 修复 OpenCode Token 解析路径错误
- ✅ 增强 Token 显示格式（显示总使用、输入、输出、推理、缓存等详细信息）
- ✅ 每次对话都显示当前会话的 Token 累计数量
